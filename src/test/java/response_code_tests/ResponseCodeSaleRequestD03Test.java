...
public class ResponseCodeSaleRequestD03Test {
    private static final String EXPECTED_RESPONSE_CODE_STRING = "responseCode=D03";

    private int amount;
    private SaleRequest saleRequest;

    public ResponseCodeSaleRequestD03Test(int amount) {
        this.amount = amount;
